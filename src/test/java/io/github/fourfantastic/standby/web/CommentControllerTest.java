	...
	public void postCommentTest() {
		...
		assertDoesNotThrow(() -> {
			mockMvc.perform(post(viewShortFilmUrl).with(csrf())
					.param("postComment", "")
					.param("newCommentText", mockShortFilmViewData.getNewCommentText()))
		...
		verify(commentService, only()).commentShortFilm(mockShortFilmViewData.getNewCommentText(), new ShortFilm(), new User());
	}
